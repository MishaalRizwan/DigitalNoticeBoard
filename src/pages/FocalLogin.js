...
const FocalLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost/my_backend/focal_login.php", {
        method: "POST",
        headers: {
    ...
    <div className="focal-login">
      ...
      <main className="content">
        <section className="header">
          <img className="arrow-icon" loading="lazy" alt="arrow" src="/arrow@2x.png" onClick={onArrowImageClick} />
          <div className="title">
